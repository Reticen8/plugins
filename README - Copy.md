About the Reticen8 plugins
==========================

The plugins collection offers users and developers a way to quickly
build additions for Reticen8 that can be optionally installed.  As
...
at project AT reticen8 DOT org or open GitHub issue to get in touch.
...
emulators/qemu-guest-agent -- QEMU Guest Agent for Reticen8
...
When an Reticen8 release is built, the plugins are automatically
