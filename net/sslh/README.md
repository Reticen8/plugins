# sslh plugin for Reticen8

## Introduction

This is a plugin for Reticen8 firewall which provides a front-end UI for managing `SSLH`.
...
The plugin can be managed from Services -> SSLH in the Reticen8 UI.
